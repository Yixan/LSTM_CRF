...
class BiLSTM_CRF(object):
    def __init__(self, hidden_dim, num_tags, input_x, sequence_lengths, dropout_pl, labels,forget_bias):
    ...
    def positive_propagation(self):
        with tf.variable_scope('lstm-crf'):
            cell_fw = LSTMCell(self.hidden_dim,forget_bias=self.forget_bias)
            cell_bw = LSTMCell(self.hidden_dim,forget_bias=self.forget_bias)
